-- Un domaine continu peut naître de compétences existantes sans émettre de
-- nouveaux codes. La création du domaine et ses tags sont une seule commande :
-- aucune panne intermédiaire ne laisse un domaine durable vide.
...
BEGIN
  ...
  IF v_type = 'creer_domaine' THEN
    ...
    END IF;
    -- Tous les codes sont validés avant la création du domaine : la commande
    -- reste atomique et ne transforme jamais un code archivé en rattachement.
