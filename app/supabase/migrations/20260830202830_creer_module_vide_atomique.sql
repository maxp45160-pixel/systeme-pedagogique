-- La création d'un module vide et la déclaration de son usage constituent une
-- seule commande : aucune panne intermédiaire ne peut laisser un domaine vide
-- et indéterminé, donc invisible dans Mes cours.
