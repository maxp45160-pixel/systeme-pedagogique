 ...
 *
 * « Preuve », « robustesse », « autonomie A0–A4 », « confiance », « dimension »
...
const ENTREES: { terme: string; definition: string }[] = [
  {
    terme: "Preuve",
    definition:
      "Une trace datée de ce que tu as réellement fait — un exercice terminé, une réalisation. C'est la seule chose que le système enregistre ; tout le reste en est dérivé et recalculé à chaque lecture.",
  },
  {
    terme: "Niveau (0 à 5)",
    definition:
      "Ce que les preuves permettent d'affirmer, pas ce que tu penses savoir. Il ne monte que si les preuves le justifient : une réussite isolée ne dépasse jamais le niveau 2.",
  },
  {
    terme: "Dimension",
    definition:
  ...
  },
  {
    terme: "Confiance",
    definition:
      "À quel point le niveau affiché est fiable. Elle dépend du nombre de preuves, de leur fraîcheur et de leur cohérence entre elles. Faible ne veut pas dire mauvais : cela veut dire « pas encore assez pour conclure ».",
  },
  {
    terme: "Robustesse (0 à 1)",
    definition:
      "La solidité de l'acquis dans le temps : plusieurs preuves, dans plusieurs contextes, étalées sur plusieurs semaines. Réussir trois fois le même exercice le même jour ne la fait pas monter.",
  },
  {
    terme: "—",
    definition:
