...
export const MESURES: DefinitionMesure[] = [
  ...
  {
    cle: "objectifs-reels",
    libelle: "Objectifs réellement atteints (aptitude)",
    unite: "part",
    sens: "haut",
    externe: true,
    valeur: (t) => t.resultatReel.partObjectifsReels,
  },
  {
    cle: "jours-resolution-reelle",
    libelle: "Jours médians jusqu'à un objectif réellement atteint",
    unite: "jours",
    sens: "bas",
    externe: true,
    valeur: (t) => t.resultatReel.joursMedianResolutionReelle,
  },
  {
    cle: "retard-reconnaissance",
    libelle: "Retard du moteur à reconnaître un objectif atteint",
    unite: "jours",
    sens: "neutre",
    externe: true,
    valeur: (t) => t.resultatReel.retardMedianReconnaissance,
  },
  {
    // Croyance du moteur, pas fait : un moteur complaisant la maximise en se
    // trompant. Interne, donc, et jamais arbitre.
    cle: "objectifs",
    libelle: "Objectifs que le moteur déclare résolus",
    unite: "part",
    sens: "haut",
    externe: false,
  ...
  },
  {
    ...
    libelle: "Jours médians jusqu'à la déclaration du moteur",
    unite: "jours",
    sens: "bas",
    externe: false,
