...
Relevé : 15/09/2026. Sources : [AGENTS](../../AGENTS.md),
[PRODUCT](../../PRODUCT.md), [ADR](../../ARCHITECTURE_DECISIONS.md).

Les invariants métier restent dans AGENTS/PRODUCT : fait déclaré, observation
sourcée et état dérivé sont distincts ; l'absence de preuve n'est pas zéro ;
le tuteur produit du contenu, pas des mesures. Les données appartiennent au compte.

Pour cette organisation, conformément au brief de Maxime :

- Décrire séparément fait observé, inférence, hypothèse et recommandation.
- Ne jamais promouvoir un statut produit ou accepter une décision à la place de Maxime.
- Lire les décisions existantes avant une proposition structurante.
